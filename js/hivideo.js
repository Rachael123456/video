     ...
     */
     hivideo.prototype = {
         ...
         */
         init: function(ele){
            this.volume_ = 0
            this.videoId_ = "hivideo" + new Date().getTime()+Math.floor(Math.random()*100+1);
     ...
     hivideo.prototype.bindPlayEvent = function(){
        ...
        [self.playBtn, self.videoPlayIcon].forEach(function(ele){
            ele.addEventListener("click", function(event){
                ...
                $('button[hivideoid="playBtn"]').removeClass("offBtn");
                $('button[hivideoid="playBtn"]').addClass("onBtn");
